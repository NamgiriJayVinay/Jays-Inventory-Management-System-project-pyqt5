...
ui,_ = loadUiType(resource_path('invent.ui'))
# ui,_= uic.loadUi(r'C:\Users\Snehith\Documents\jay invent\invent.ui', self)
login,_ = loadUiType(resource_path('logintoqt.ui'))
# login,_= uic.loadUi(r'C:\Users\Snehith\Documents\jay invent\invent.ui', self)
...
class Login(QWidget , login):
    ...
    def Handel_Login(self):
        self.db = sqlite3.connect(resource_path('data.sqlite'))
...
class MainApp(QMainWindow , ui):
    ...
    def Handel_Buttons(self):
        ...
        self.pushButton_30.clicked.connect(self.sy_Theme)
        self.pushButton_31.clicked.connect(self.green_Theme)
        self.pushButton_32.clicked.connect(self.cyan_Theme)
    ...
    def Show_All_Operations(self):
        ...
        self.cur.execute(''' 
            SELECT book_name , client , type , date  FROM dayoperations
        ''')
    ...
    def Edit_Client(self):
        ...
        self.cur.execute('''
            UPDATE clients SET client_name = ? , client_email = ? , client_nationalid = ? WHERE client_nationalid = ?
   ...
   ########################################
    ...
    def Export_Books(self):
        ...
        sheet1.write(0,2 , 'Product Description')
        sheet1.write(0,3 , 'Product Category')
        sheet1.write(0,4 , 'Product Author')
        sheet1.write(0,5 , 'Product publisher')
        sheet1.write(0,6 , 'Product Price')
   ...
   ########################################
    ...
    def sy_Theme(self):
        style = open('themes/SyNet.qss' , 'r')
        style = style.read()
        self.setStyleSheet(style)
    def green_Theme(self):
        style = open('themes/SpyBot.qss' , 'r')
        style = style.read()
        self.setStyleSheet(style)
    def cyan_Theme(self):
        style = open('themes/Toolery.qss' , 'r')
        style = style.read()
        self.setStyleSheet(style)
